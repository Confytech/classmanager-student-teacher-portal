# classmanager 
# Class Manager Student Teacher Portal App _ by Confidence Chinaza Ehiemere

## Live Demo Link 
👉 https://classmanager-student-teacher-portal-ug8f.onrender.com/
A Student-Teacher Portal built using HTML, CSS, Python and Django

Class Manager is a Student-Teacher Portal where techers and student can sign up and teachers can add students and upload tasks to their classes for Students to see and do.
